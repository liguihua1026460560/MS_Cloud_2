...
@AllArgsConstructor
@NoArgsConstructor
@XmlRootElement(name = "FsQuotaConfigResult")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "FsQuotaConfigResult", propOrder = {
        "bucket",
        "dirName",
        "quotaType",
        "filesSoftQuota",
...
public class FsQuotaConfigResult {
    ...
    public static FsQuotaConfigResult mapToFsQuotaConfigResult(FSQuotaConfig fsQuotaConfig) {
        return new FsQuotaConfigResult()
