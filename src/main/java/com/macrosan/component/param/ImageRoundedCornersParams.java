 ...
 * @description: 圆角矩形参数
 **/
public class ImageRoundedCornersParams implements ProcessParams {
    public String r;

    @Override
    public void checkParams() {
        if (StringUtils.isBlank(r)) {
            throw new MsException(ErrorNo.INVALID_COMPONENT_PARAM, "rounded corners process: r is invalid.");
        }
        // r为正整数 1-4096
